...
#ifndef HIPE_EPIPHANY_H
#define HIPE_EPIPHANY_H

static __inline__ void
hipe_flush_icache_word(void *address)
{
    /* No icache */
}
...
#define HIPE_RA_LSR_COUNT	1	/* lowest bit is always zero */
