...
#define STUB_BIF_0(N) BIF_RETTYPE __attribute__((weak)) N(BIF_ALIST_0) { EPIPHANY_STUB(N); }
#define STUB_BIF_1(N) BIF_RETTYPE __attribute__((weak)) N(BIF_ALIST_1) { EPIPHANY_STUB(N); }
#define STUB_BIF_2(N) BIF_RETTYPE __attribute__((weak)) N(BIF_ALIST_2) { EPIPHANY_STUB(N); }
#define STUB_BIF_3(N) BIF_RETTYPE __attribute__((weak)) N(BIF_ALIST_3) { EPIPHANY_STUB(N); }
