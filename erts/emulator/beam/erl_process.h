...
#endif
#ifdef ERTS_SLAVE_EMU_ENABLED
#define ERTS_PSFLG_SLAVE		ERTS_PSFLG_BIT(22)
#endif
...
#  define HEAP_FRAG_ALC(P) (IS_SLAVE_PROCESS(P)				\
			    ? ERTS_ALC_T_SLAVE_HEAP_FRAG : ERTS_ALC_T_HEAP_FRAG)
#endif
