...
create_matchstate(Max, BinSize, Base, Offset, Orig, Ms) -> 
  ...
  [GetHPInsn,
   set_field_from_pointer({matchstate,thing_word}, HP, Header),
   set_field_from_pointer({matchstate,{matchbuffer,orig}}, HP, Orig),
   set_field_from_pointer({matchstate,{matchbuffer,base}}, HP, Base),
   set_field_from_pointer({matchstate,{matchbuffer,binsize}}, HP, BinSize),
   set_field_from_pointer({matchstate,{matchbuffer,offset}}, HP, Offset),
   set_field_from_pointer({matchstate,{saveoffset, 0}}, HP, Offset),
