...
needs_redtest(Leafness) ->
  case Leafness of
    ...
    %% what othere leaves may contain. Omitting the redtest is safe since they
    %% may only tailcall non-closures, and is useful to generate shorter code
    %% for closures generated by (fun F/A).
    closure -> false;
    selfrec -> true;
    false -> true
  end.
