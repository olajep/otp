...
%% --------------------------------------------------------------------------
%% Copy of bs_match_bin_SUITE from the BEAM suites. match_huge_bin in
%% particular found various edge cases in the implementation of bs_skip_bits.
%% --------------------------------------------------------------------------
-module(bs_match_bin).
...
bit_split_binary() ->
    ...
    bit_split_binary1(Fun, make_unaligned_sub_binary(erlang:md5(<<1,2,3>>))),
    ok.
